...
int main(int argc, char* argv[])
{
	...
	glfModel model;
	useThis =(int*) calloc(4 + 4 * 4 * 2 + 4 * 16 * 3 + 4 * 64 * 2 + 4 * 256,sizeof(int)); // numbers of combinations for 1,2,3,4,5 bases
	useThese = (int*)calloc(4 + 4 * 4 * 2 + 4 * 16 * 3 + 4 * 64 * 2 + 4 * 256, sizeof(int));
	for (comp = 0; comp < 4 + 4 * 4 * 2 + 4 * 16 * 3; ++comp)
